...
| `open`                    | boolean | undefined           | Programmatically show (`true`) or hide (`false`) the tooltip, independently of hover/focus events. When `undefined` (not passed), normal hover/focus behavior applies unchanged.                                                                                                                                                       |
