...
| `position`                | string  | 'top'               | Position of the tooltip. Available values: 'top', 'bottom', 'left', 'right'. The tooltip automatically flips to the opposite side if it would overflow the viewport. |
